 ...
 * Description: Handles all message activity (ie. messages appearing, replying, being sent to the database, etc.)
 *
 * Changes:             Author  |   Date    |   Description
 *                      J.Jones     6-June-16   Create file, added core functionality.
 */
